...
const unsigned short dmpMemoryLength = sizeof(dmpMemory);
...
const unsigned short dmpConfigLength = sizeof(dmpConfig);
...
const unsigned short dmpUpdatesLength = sizeof(dmpUpdates);
